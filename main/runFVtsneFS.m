function [] = runFVtsneFS(param,tsne_param)
...
%% feature selection
ranking = feat_selection(data,ones(size(data,1),1),fs_meth);
...
figure;set(gcf,'color','w','position',[2032,660 990 266])
