...
[coeff,w,mu,sigma,mbhxFV,eigval] = encodeSpFV2(fileIndx,K,filepath,...
    [infostr '_mbh'],intran,powern);

% save results
save([savepath infostr '_mbhCoeff.mat'],'coeff','eigval','-v7.3'); 
save([savepath infostr '_mbhFV.mat'],'mbhFV','-v7.3');
save([savepath infostr '_mbhGMM.mat'],'w','mu','sigma','-v7.3');

%% put together data
FVall = [trajFV,hofFV,hogFV,mbhFV]/5;
