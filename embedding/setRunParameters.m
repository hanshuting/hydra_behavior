...
%     Princeton University
   ...
   %threshold for image segmentation
    ...
    %path to basis image
    basisImagePath = '/home/sh3276/software/MotionMapper/segmentation_alignment/basisImage.tiff';
...
%     parameters.basisImage = imread(parameters.basisImagePath);
    ...
    if ~isfield(parameters,'distType') || isempty(parameters.distType)
        parameters.distType = distType;
    end
